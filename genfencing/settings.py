"""
Django settings for genfencing project.
...
SECRET_KEY = 'django-insecure-dl6=47)1)&w6&2px$ldt7r!#5cshhmi@u+jcrokvcmsgnoxg_6'
...
WSGI_APPLICATION = 'genfencing.wsgi.application'
...
# CORS_ALLOW_HEADERS = ['"https://185.199.52.197",']
